...
def hsk_position_train_serialize(file_name):
    ...
    my_file = codecs.open(os.path.join('crf_file', 'cged16_hsk_word_pos', 'cged15_test_file.txt'), 'w', 'utf8')
    for doc in docs:
...
if __name__ == '__main__':
    ...
    train_file = os.path.join('corpus', 'nlptea15cged_release1.0', 'Test', 'NLPTEA15_CGED_Test.sgml')
